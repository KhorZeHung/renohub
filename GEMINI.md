...
## Front end design
- always create skeleton for loading states
...
- do not split desktop layout and mobile layout, all must be in 1 component.  

## Backend Patterns
- refer to /documentation/backend.md for existing API
